...
namespace Hook
{
	...
	public:
		...
		inline static bool ValidPointer(uintptr_t Pointer)
		{
		...
		inline void Insert(void* HookFunction, int Index, OriginalType* OutOriginalFunction)
		{
...
namespace NewHook
{
	inline Hook::NewHook ViewportHook;
}