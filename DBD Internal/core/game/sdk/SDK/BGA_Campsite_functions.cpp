...
void ABGA_Campsite_C::Build_Campsite_Improvement(Enum_Campsite_Improvements Improvement_Type, class APlayerState* Improvement_Owner, const struct FVector& Spawn_Location, const struct FRotator& Spawn_Transform_Rotation, class AActor* SupportingActor)
{
	static class UFunction* Func = nullptr;
...
// const struct FGameplayTag&              DeplayGameplayCueTag                                   (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
...
void ABGA_Campsite_C::EstablishNewCampsite(class APlayerState* New_Campsite_Instigator, class AActor* SupportingActor)
{
	static class UFunction* Func = nullptr;
...
// const struct FStruct_Campsite_Improvement&Struct_Campsite_Improvement                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
