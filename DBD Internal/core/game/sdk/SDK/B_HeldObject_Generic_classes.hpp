...
static_assert(sizeof(AB_HeldObject_Generic_C) == 0x000D18, "Wrong size on AB_HeldObject_Generic_C");
static_assert(offsetof(AB_HeldObject_Generic_C, UberGraphFrame) == 0x000D08, "Member 'AB_HeldObject_Generic_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_HeldObject_Generic_C, StaticMesh) == 0x000D10, "Member 'AB_HeldObject_Generic_C::StaticMesh' has a wrong offset!");
