...
public:
	...
	TArray<class AFortPlayerController*>          CallFunc_GetLocalFortPlayerControllers_ReturnValue_1; // 0x0048(0x0010)(ReferenceParm, HasGetValueTypeHash)
	...
	TDelegate<void(class AFortMinigame* Minigame, EFortMinigameState MinigameState)> K2Node_CreateDelegate_OutputDelegate; // 0x006C(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          CallFunc_NotEqual_IntInt_ReturnValue_1;            // 0x007E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_7F[0x1];                                       // 0x007F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_GetOptionValueNameFromValue_ReturnValue;  // 0x0080(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetOptionKey_ReturnValue;                 // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	TArray<class FString>                         K2Node_MakeArray_Array;                            // 0x00A0(0x0010)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	TMap<class FString, class FString>            K2Node_MakeMap_Map;                                // 0x00B0(0x0050)(ConstParm)
	bool                                          CallFunc_SetPropertyOverrides_ReturnValue;         // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AFortMinigame*                          CallFunc_GetCurrentMinigame_Minigame;              // 0x0128(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortMinigame*                          K2Node_CustomEvent_Minigame;                       // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortMinigameState                            K2Node_CustomEvent_MinigameState;                  // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine) == 0x000140, "Wrong size on MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine");
...
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_bool_Has_Been_Initd_Variable) == 0x000028, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
...
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_Array_Get_Item_1) == 0x000058, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_AsFort_Player_Controller_Athena_1) == 0x000060, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_AsFort_Player_Controller_Athena_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_HasAuthority_ReturnValue) == 0x000069, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate) == 0x00006C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00007C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_NotEqual_IntInt_ReturnValue) == 0x00007D, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_NotEqual_IntInt_ReturnValue_1) == 0x00007E, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_NotEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetOptionValueNameFromValue_ReturnValue) == 0x000080, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetOptionValueNameFromValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetOptionKey_ReturnValue) == 0x000090, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetOptionKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_MakeArray_Array) == 0x0000A0, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_MakeMap_Map) == 0x0000B0, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_MakeMap_Map' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_SetPropertyOverrides_ReturnValue) == 0x000100, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_SetPropertyOverrides_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate_1) == 0x000104, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate_2) == 0x000114, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_int_Variable) == 0x000124, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetCurrentMinigame_Minigame) == 0x000128, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetCurrentMinigame_Minigame' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CustomEvent_Minigame) == 0x000130, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CustomEvent_Minigame' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CustomEvent_MinigameState) == 0x000138, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CustomEvent_MinigameState' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000139, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_IsValid_ReturnValue) == 0x00013A, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_bool_Variable) == 0x00013B, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_Select_Default) == 0x00013C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_Select_Default' has a wrong offset!");
