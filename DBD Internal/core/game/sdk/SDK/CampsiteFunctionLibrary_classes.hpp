...
public:
	...
	static void Spawn_And_Establish_New_Campsite(class AFortPlayerStateAthena* Player_State_Athena, const struct FTransform& Transform, class AActor* SupportingActor, class UObject* __WorldContext, class ABGA_Campsite_C** AsBGA_Campsite);
