...
static_assert(sizeof(UGA_FuelEquipped_C) == 0x000AC0, "Wrong size on UGA_FuelEquipped_C");
static_assert(offsetof(UGA_FuelEquipped_C, UberGraphFrame) == 0x000AB8, "Member 'UGA_FuelEquipped_C::UberGraphFrame' has a wrong offset!");
