...
public:
	...
	TArray<struct FGuid>                          StackGuids;                                        // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraScalabilityManager) == 0x000068, "Wrong size on FNiagaraScalabilityManager");
