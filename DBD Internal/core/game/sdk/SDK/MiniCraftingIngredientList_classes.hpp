...
static_assert(sizeof(UMiniCraftingIngredientList_C) == 0x000328, "Wrong size on UMiniCraftingIngredientList_C");
static_assert(offsetof(UMiniCraftingIngredientList_C, UberGraphFrame) == 0x000318, "Member 'UMiniCraftingIngredientList_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMiniCraftingIngredientList_C, EntriesWrapBox) == 0x000320, "Member 'UMiniCraftingIngredientList_C::EntriesWrapBox' has a wrong offset!");
