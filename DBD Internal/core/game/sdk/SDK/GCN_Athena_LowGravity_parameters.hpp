...
static_assert(sizeof(GCN_Athena_LowGravity_C_ExecuteUbergraph_GCN_Athena_LowGravity) == 0x0000E8, "Wrong size on GCN_Athena_LowGravity_C_ExecuteUbergraph_GCN_Athena_LowGravity");
...
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, CallFunc_GetTimeSeconds_ReturnValue) == 0x000014, "Member 'GCN_Athena_LowGravity_C_Activated::CallFunc_GetTimeSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000018, "Member 'GCN_Athena_LowGravity_C_Activated::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, CallFunc_EvaluateCurveTableRow_OutResult) == 0x00001C, "Member 'GCN_Athena_LowGravity_C_Activated::CallFunc_EvaluateCurveTableRow_OutResult' has a wrong offset!");
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, CallFunc_EvaluateCurveTableRow_OutXY) == 0x000020, "Member 'GCN_Athena_LowGravity_C_Activated::CallFunc_EvaluateCurveTableRow_OutXY' has a wrong offset!");
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, CallFunc_EvaluateCurveTableRow_OutResult_1) == 0x000024, "Member 'GCN_Athena_LowGravity_C_Activated::CallFunc_EvaluateCurveTableRow_OutResult_1' has a wrong offset!");
...
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, K2Node_SwitchEnum_CmpSuccess) == 0x00002C, "Member 'GCN_Athena_LowGravity_C_Activated::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GCN_Athena_LowGravity_C_Activated, K2Node_SwitchEnum_CmpSuccess_1) == 0x00002D, "Member 'GCN_Athena_LowGravity_C_Activated::K2Node_SwitchEnum_CmpSuccess_1' has a wrong offset!");
