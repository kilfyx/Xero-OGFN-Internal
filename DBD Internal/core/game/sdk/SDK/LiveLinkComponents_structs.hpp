...
static_assert(sizeof(FLiveLinkTransformControllerData) == 0x000004, "Wrong size on FLiveLinkTransformControllerData");
...
static_assert(offsetof(FLiveLinkTransformControllerData, bUseScale) == 0x000001, "Member 'FLiveLinkTransformControllerData::bUseScale' has a wrong offset!");
static_assert(offsetof(FLiveLinkTransformControllerData, bSweep) == 0x000002, "Member 'FLiveLinkTransformControllerData::bSweep' has a wrong offset!");
static_assert(offsetof(FLiveLinkTransformControllerData, bTeleport) == 0x000003, "Member 'FLiveLinkTransformControllerData::bTeleport' has a wrong offset!");
