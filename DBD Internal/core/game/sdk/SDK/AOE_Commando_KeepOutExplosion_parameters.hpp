...
static_assert(sizeof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius) == 0x000750, "Wrong size on AOE_Commando_KeepOutExplosion_C_OnRep_Radius");
...
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, CallFunc_BP_GetAttenuationSettingsToApply_ReturnValue) == 0x0003A0, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::CallFunc_BP_GetAttenuationSettingsToApply_ReturnValue' has a wrong offset!");
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, CallFunc_MakeVector_ReturnValue) == 0x0003A4, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, K2Node_MakeStruct_SoundAttenuationSettings) == 0x0003B0, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::K2Node_MakeStruct_SoundAttenuationSettings' has a wrong offset!");
