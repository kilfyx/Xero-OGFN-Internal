...
static_assert(sizeof(UGA_HeldObject_Drop_C) == 0x000AC0, "Wrong size on UGA_HeldObject_Drop_C");
static_assert(offsetof(UGA_HeldObject_Drop_C, UberGraphFrame) == 0x000AB8, "Member 'UGA_HeldObject_Drop_C::UberGraphFrame' has a wrong offset!");
