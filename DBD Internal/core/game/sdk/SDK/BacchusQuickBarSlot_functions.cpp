...
void UBacchusQuickbarSlot_C::OnExtensionWidgetAdded(const EUIExtensionSlot ExtensionSlot, class UUserWidget* ExtensionWidget)
{
	static class UFunction* Func = nullptr;
	...
	Params::BacchusQuickbarSlot_C_OnExtensionWidgetAdded Parms{};
