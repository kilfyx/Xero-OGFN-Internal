...
// const class UFortItem*                  ItemToRepresent                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaInteractionIndicator_C::GetInteractPlayerCount(class UFortInteractContextInfo* CurrentInteraction_0, int32* InteractionCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaInteractionIndicator_C", "GetInteractPlayerCount");

	Params::AthenaInteractionIndicator_C_GetInteractPlayerCount Parms{};
...
void UAthenaInteractionIndicator_C::OnMultiInteractCountChanged(int32 InteractingPlayerCount, float MultiInteractMultiplier, float InteractingDuration)
{
	static class UFunction* Func = nullptr;
