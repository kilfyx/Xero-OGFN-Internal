...
// Package: GCN_Athena_HidingProp_Tent_Exit

#include "Basic.hpp"

#include "GCN_Athena_HidingProp_Tent_Exit_classes.hpp"
#include "GCN_Athena_HidingProp_Tent_Exit_parameters.hpp"


namespace SDK
{

// Function GCN_Athena_HidingProp_Tent_Exit.GCN_Athena_HidingProp_Tent_Exit_C.OnBurst
...
void UGCN_Athena_HidingProp_Tent_Exit_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_HidingProp_Tent_Exit_C", "OnBurst");

	Params::GCN_Athena_HidingProp_Tent_Exit_C_OnBurst Parms{};
