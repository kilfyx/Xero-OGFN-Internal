...
static_assert(offsetof(QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue, Attack_Speed) == 0x00000C, "Member 'QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue::Attack_Speed' has a wrong offset!");
static_assert(offsetof(QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue, Release_Speed) == 0x000010, "Member 'QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue::Release_Speed' has a wrong offset!");
static_assert(offsetof(QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue, ReturnValue) == 0x000014, "Member 'QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue::ReturnValue' has a wrong offset!");
