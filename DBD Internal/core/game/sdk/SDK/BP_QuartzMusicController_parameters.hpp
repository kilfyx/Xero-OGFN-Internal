...
static_assert(alignof(BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController) == 0x000008, "Wrong alignment on BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController");
static_assert(sizeof(BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController) == 0x000018, "Wrong size on BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController");
static_assert(offsetof(BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController, EntryPoint) == 0x000000, "Member 'BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController, CallFunc_GetWorldSubsystem_ReturnValue) == 0x000008, "Member 'BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController::CallFunc_GetWorldSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController, CallFunc_IsQuartzEnabled_ReturnValue) == 0x000010, "Member 'BP_QuartzMusicController_C_ExecuteUbergraph_BP_QuartzMusicController::CallFunc_IsQuartzEnabled_ReturnValue' has a wrong offset!");
