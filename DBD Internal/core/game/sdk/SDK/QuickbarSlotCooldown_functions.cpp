...
void UQuickbarSlotCooldown_C::OnCooldownStarted(EFortItemCooldownType CooldownType, float CooldownDuration)
{
	static class UFunction* Func = nullptr;
...
void UQuickbarSlotCooldown_C::OnAmmoRegenerationUpdated(bool bOutAmmoRegenAvailableState)
{
	...
	Params::QuickbarSlotCooldown_C_OnAmmoRegenerationUpdated Parms{};
...
// TArray<EFortItemCooldownType>&          DesiredCooldownTypesSupported                          (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
