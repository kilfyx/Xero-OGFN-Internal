...
// Function LevelUpVisuals.LevelUpVisuals_C.OnInitialized
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void ULevelUpVisuals_C::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelUpVisuals_C", "OnInitialized");
...
void ULevelUpVisuals_C::ResetAnimationState()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LevelUpVisuals_C", "ResetAnimationState");
