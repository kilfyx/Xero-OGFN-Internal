...
static_assert(sizeof(ALoginCamera_Blueprint_C) == 0x000800, "Wrong size on ALoginCamera_Blueprint_C");
static_assert(offsetof(ALoginCamera_Blueprint_C, UberGraphFrame) == 0x0007E0, "Member 'ALoginCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ALoginCamera_Blueprint_C, StaticMesh) == 0x0007E8, "Member 'ALoginCamera_Blueprint_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ALoginCamera_Blueprint_C, LoginCamera_0) == 0x0007F0, "Member 'ALoginCamera_Blueprint_C::LoginCamera_0' has a wrong offset!");
