...
// (Event, Protected, BlueprintEvent)
// Parameters:
// const EUIExtensionSlot                  SlotType                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UUserWidget*                      Widget                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaSquadList_C::OnExtensionWidgetAdded(const EUIExtensionSlot SlotType, class UUserWidget* Widget)
{
	static class UFunction* Func = nullptr;
	...
	Params::AthenaSquadList_C_OnExtensionWidgetAdded Parms{};
