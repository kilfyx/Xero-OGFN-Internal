...
void UCreativeMiniGameInfoWidget_C::BndEvt__HideDetailsButton_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	static class UFunction* Func = nullptr;
...
void UCreativeMiniGameInfoWidget_C::BndEvt__ShowDetailsButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	static class UFunction* Func = nullptr;
...
void UCreativeMiniGameInfoWidget_C::BndEvt__StartGameButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	static class UFunction* Func = nullptr;
...
void UCreativeMiniGameInfoWidget_C::BndEvt__SupportAffliateButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	static class UFunction* Func = nullptr;
...
// bool                                    bIsEntering                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCreativeMiniGameInfoWidget_C::ShowDetailsPanel(bool ShouldShow, bool ShouldAnimate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CreativeMiniGameInfoWidget_C", "ShowDetailsPanel");

	Params::CreativeMiniGameInfoWidget_C_ShowDetailsPanel Parms{};
