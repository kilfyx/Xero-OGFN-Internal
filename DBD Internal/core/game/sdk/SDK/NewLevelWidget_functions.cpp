...
// Parameters:
// const int32                             NewLevel                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UNewLevelWidget_C::OnShowWidget(const int32 NewLevel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NewLevelWidget_C", "OnShowWidget");

	Params::NewLevelWidget_C_OnShowWidget Parms{};
