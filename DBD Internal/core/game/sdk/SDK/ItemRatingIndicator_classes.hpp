...
static_assert(sizeof(UItemRatingIndicator_C) == 0x000610, "Wrong size on UItemRatingIndicator_C");
static_assert(offsetof(UItemRatingIndicator_C, UberGraphFrame) == 0x0005F0, "Member 'UItemRatingIndicator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemRatingIndicator_C, Moonbeam_Power_Back_1) == 0x0005F8, "Member 'UItemRatingIndicator_C::Moonbeam_Power_Back_1' has a wrong offset!");
static_assert(offsetof(UItemRatingIndicator_C, PowerRatingIconImage) == 0x000600, "Member 'UItemRatingIndicator_C::PowerRatingIconImage' has a wrong offset!");
static_assert(offsetof(UItemRatingIndicator_C, PowerRatingText) == 0x000608, "Member 'UItemRatingIndicator_C::PowerRatingText' has a wrong offset!");
