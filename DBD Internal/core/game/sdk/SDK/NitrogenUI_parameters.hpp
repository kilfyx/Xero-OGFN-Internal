...
static_assert(sizeof(NitrogenFareBonusWidget_OnActiveBonusUpdated) == 0x000178, "Wrong size on NitrogenFareBonusWidget_OnActiveBonusUpdated");
...
static_assert(offsetof(NitrogenFareBonusWidget_OnActiveBonusUpdated, Value) == 0x000170, "Member 'NitrogenFareBonusWidget_OnActiveBonusUpdated::Value' has a wrong offset!");
static_assert(offsetof(NitrogenFareBonusWidget_OnActiveBonusUpdated, ShouldAwardBonus) == 0x000174, "Member 'NitrogenFareBonusWidget_OnActiveBonusUpdated::ShouldAwardBonus' has a wrong offset!");
static_assert(offsetof(NitrogenFareBonusWidget_OnActiveBonusUpdated, bEndOfFare) == 0x000175, "Member 'NitrogenFareBonusWidget_OnActiveBonusUpdated::bEndOfFare' has a wrong offset!");
...
static_assert(sizeof(NitrogenFareMeterWidget_OnActiveBonusUpdated) == 0x000178, "Wrong size on NitrogenFareMeterWidget_OnActiveBonusUpdated");
...
static_assert(offsetof(NitrogenFareMeterWidget_OnActiveBonusUpdated, Value) == 0x000170, "Member 'NitrogenFareMeterWidget_OnActiveBonusUpdated::Value' has a wrong offset!");
static_assert(offsetof(NitrogenFareMeterWidget_OnActiveBonusUpdated, bShouldAwardBonus) == 0x000174, "Member 'NitrogenFareMeterWidget_OnActiveBonusUpdated::bShouldAwardBonus' has a wrong offset!");
static_assert(offsetof(NitrogenFareMeterWidget_OnActiveBonusUpdated, bEndOfFare) == 0x000175, "Member 'NitrogenFareMeterWidget_OnActiveBonusUpdated::bEndOfFare' has a wrong offset!");
...
static_assert(alignof(NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat) == 0x000008, "Wrong alignment on NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat");
static_assert(sizeof(NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat) == 0x000008, "Wrong size on NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat");
static_assert(offsetof(NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat, NewVehicle) == 0x000000, "Member 'NitrogenObjectiveWidget_HandleVehicleEnteredDriverSeat::NewVehicle' has a wrong offset!");
