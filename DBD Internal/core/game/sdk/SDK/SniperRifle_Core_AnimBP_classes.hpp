...
class USniperRifle_Core_AnimBP_C final : public UAnimInstance
{
public:
...
public:
	...
	void ExecuteUbergraph_SniperRifle_Core_AnimBP(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SniperRifle_Core_AnimBP_C">();
	}
	static class USniperRifle_Core_AnimBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USniperRifle_Core_AnimBP_C>();
	}
};
