...
void AB_Prj_Ranged_GrenadeLauncher_Athena_C::BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_0_WaterInteractionOnEnterWater__DelegateSignature(class AFortWaterBodyActor* WaterBody, class UFortWaterInteractionComponent* WaterInteractionComponent_0, bool bIsFirstBody)
{
...
void AB_Prj_Ranged_GrenadeLauncher_Athena_C::SpawnBounceFX(struct FHitResult& Hit, class AActor** HitActor, EPhysicalSurface* SurfaceType_0, struct FRotator* HitResultRotation)
{
	static class UFunction* Func = nullptr;
...
void AB_Prj_Ranged_GrenadeLauncher_Athena_C::Splash(class AFortWaterBodyActor* WaterBody, class UFortWaterInteractionComponent* WaterInteractionComponent_0, bool bIsFirstBody)
{
	static class UFunction* Func = nullptr;
