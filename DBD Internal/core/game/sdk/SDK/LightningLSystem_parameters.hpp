...
public:
	...
	struct FHitResult                             CallFunc_K2_AddLocalRotation_SweepHitResult;       // 0x005C(0x009C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                             CallFunc_K2_SetRelativeTransform_SweepHitResult;   // 0x0160(0x009C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
