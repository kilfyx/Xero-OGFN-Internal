...
static_assert(offsetof(WrapPreview_C_LightControl, CallFunc_IsInPerformanceMode_ReturnValue) == 0x000010, "Member 'WrapPreview_C_LightControl::CallFunc_IsInPerformanceMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_LightControl, CallFunc_IsMobileGame_ReturnValue) == 0x000011, "Member 'WrapPreview_C_LightControl::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WrapPreview_C_LightControl, CallFunc_IsErebus_ReturnValue) == 0x000013, "Member 'WrapPreview_C_LightControl::CallFunc_IsErebus_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WrapPreview_C_LightControl, CallFunc_BooleanOR_ReturnValue_1) == 0x000025, "Member 'WrapPreview_C_LightControl::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_LightControl, CallFunc_BooleanOR_ReturnValue_2) == 0x000026, "Member 'WrapPreview_C_LightControl::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
...
public:
	...
	class UFortGameUserSettings*                  CallFunc_GetFortGameUserSettings_ReturnValue;      // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bEnableAutotestBackground;            // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsInPerformanceMode_ReturnValue;          // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WrapPreview_C_ExecuteUbergraph_WrapPreview) == 0x000070, "Wrong size on WrapPreview_C_ExecuteUbergraph_WrapPreview");
...
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_BooleanOR_ReturnValue_1) == 0x000063, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
