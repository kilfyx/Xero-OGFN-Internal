...
static_assert(alignof(UVector3) == 0x000008, "Wrong alignment on UVector3");
static_assert(sizeof(UVector3) == 0x000038, "Wrong size on UVector3");
static_assert(offsetof(UVector3, __verse_0x6F57CF8F_x) == 0x000028, "Member 'UVector3::__verse_0x6F57CF8F_x' has a wrong offset!");
static_assert(offsetof(UVector3, __verse_0x0A307337_y) == 0x00002C, "Member 'UVector3::__verse_0x0A307337_y' has a wrong offset!");
static_assert(offsetof(UVector3, __verse_0xE49FC625_z) == 0x000030, "Member 'UVector3::__verse_0xE49FC625_z' has a wrong offset!");
