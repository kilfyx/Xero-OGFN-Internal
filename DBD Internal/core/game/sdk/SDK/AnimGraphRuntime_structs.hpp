...
public:
	...
	uint8                                         Pad_208[0x458];                                    // 0x0208(0x0458)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000660, "Wrong size on FAnimNode_RigidBody");
...
public:
	...
	struct FRBFParams                             RBFParams;                                         // 0x00F8(0x002C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	EPoseDriverSource                             DriveSource;                                       // 0x0124(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPoseDriverOutput                             DriveOutput;                                       // 0x0125(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOnlyDriveSelectedBones : 1;                       // 0x0126(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_127[0x1];                                      // 0x0127(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LODThreshold;                                      // 0x0128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_PoseDriver, LODThreshold) == 0x000128, "Member 'FAnimNode_PoseDriver::LODThreshold' has a wrong offset!");
