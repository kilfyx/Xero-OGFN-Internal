...
public:
	...
	struct FHitResult                             K2Node_Event_HitInfo_2;                            // 0x003C(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FFortAnalyticsEventAttribute           K2Node_MakeStruct_FortAnalyticsEventAttribute;     // 0x0108(0x0020)()
	...
	struct FHitResult                             K2Node_Event_HitInfo_1;                            // 0x015C(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AFortPawn*                              K2Node_Event_InstigatedBy_1;                       // 0x01F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_DamageCauser_1;                       // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                K2Node_Event_Momentum;                             // 0x0248(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_HitInfo;                              // 0x0254(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue;            // 0x0318(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle            CallFunc_ApplyGlobalEnvironmentGameplayEffectToActor_ReturnValue; // 0x0330(0x0008)(NoDestructor, HasGetValueTypeHash)
};
