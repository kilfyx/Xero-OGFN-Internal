...
public:
	...
	bool                                          CallFunc_IsServer_ReturnValue;                     // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             K2Node_ComponentBoundEvent_ImpactResult_1;         // 0x0080(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FVector                                K2Node_ComponentBoundEvent_ImpactVelocity;         // 0x011C(0x000C)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABGA_GenericCurieFuel_Parent_C*         K2Node_DynamicCast_AsBGA_Generic_Curie_Fuel_Parent; // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortAsyncAction_OnCurieActivated*      CallFunc_OnCurieActivated_ReturnValue;             // 0x0158(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FCurieContainerHandle                  K2Node_Event_CurieContainerHandle;                 // 0x0164(0x0004)(ConstParm, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_ElementTag;                           // 0x0168(0x0008)(ConstParm, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue;       // 0x0170(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_bSelfMoved;                           // 0x0190(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_Hit;                                  // 0x01B8(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             K2Node_ComponentBoundEvent_ImpactResult;           // 0x0254(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
public:
	...
	struct FHitResult                             CallFunc_MakeHitResult_ReturnValue;                // 0x0064(0x009C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
public:
	...
	struct FHitResult                             Temp_struct_Variable;                              // 0x0018(0x009C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
