...
static_assert(sizeof(URedirectToEpicAccount_C) == 0x0004A8, "Wrong size on URedirectToEpicAccount_C");
static_assert(offsetof(URedirectToEpicAccount_C, Image_4) == 0x0004A0, "Member 'URedirectToEpicAccount_C::Image_4' has a wrong offset!");
