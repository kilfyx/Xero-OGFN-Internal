...
#include "GCN_Burst_TrackingPistolFlash_classes.hpp"
#include "GCN_Burst_TrackingPistolFlash_parameters.hpp"
...
void UGCN_Burst_TrackingPistolFlash_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Burst_TrackingPistolFlash_C", "OnBurstGeneric");

	Params::GCN_Burst_TrackingPistolFlash_C_OnBurstGeneric Parms{};
