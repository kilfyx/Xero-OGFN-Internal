...
public:
	...
	class UCommonButton*                          CallFunc_GetSelectedButton_ReturnValue;            // 0x0008(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
