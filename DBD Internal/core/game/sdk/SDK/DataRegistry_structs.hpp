...
static_assert(sizeof(FDataRegistryLookup) == 0x000010, "Wrong size on FDataRegistryLookup");
...
static_assert(offsetof(FDataRegistrySource_DataTableRules, bUseHardReference) == 0x000000, "Member 'FDataRegistrySource_DataTableRules::bUseHardReference' has a wrong offset!");
