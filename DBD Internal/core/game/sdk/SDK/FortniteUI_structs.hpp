...
enum class EAthenaNewsEntryType : uint8
{
	...
	STWUpsell                                = 9,
	Challenge                                = 10,
	SpatialBattlePass                        = 11,
	BattlePassPurchaseScreen                 = 12,
	Setting                                  = 13,
	Playlist                                 = 14,
	NavigateToSpatialScreen                  = 15,
	Invalid                                  = 16,
	EAthenaNewsEntryType_MAX                 = 17,
};
...
enum class EFortServerBrowserAction : uint8
{
	...
	EFortServerBrowserAction_MAX             = 5,
};
...
public:
	...
	TArray<struct FImageRef>                      Image;                                             // 0x0030(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FImageRef>                      TileImage;                                         // 0x0040(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FString                                 ID;                                                // 0x0090(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int64                                         SortingPriority;                                   // 0x00A0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaMOTDBase) == 0x000008, "Wrong alignment on FAthenaMOTDBase");
static_assert(sizeof(FAthenaMOTDBase) == 0x0000B0, "Wrong size on FAthenaMOTDBase");
...
static_assert(offsetof(FAthenaMOTDBase, Image) == 0x000030, "Member 'FAthenaMOTDBase::Image' has a wrong offset!");
static_assert(offsetof(FAthenaMOTDBase, TileImage) == 0x000040, "Member 'FAthenaMOTDBase::TileImage' has a wrong offset!");
...
static_assert(offsetof(FAthenaMOTDBase, ID) == 0x000090, "Member 'FAthenaMOTDBase::ID' has a wrong offset!");
static_assert(offsetof(FAthenaMOTDBase, SortingPriority) == 0x0000A0, "Member 'FAthenaMOTDBase::SortingPriority' has a wrong offset!");
...
{
public:
	EFortUIFeature                                NavigateToTabValue;                                // 0x00B0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 NavigateToTabButtonText;                           // 0x00B8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNavigateToTabMOTD) == 0x000008, "Wrong alignment on FNavigateToTabMOTD");
static_assert(sizeof(FNavigateToTabMOTD) == 0x0000C8, "Wrong size on FNavigateToTabMOTD");
static_assert(offsetof(FNavigateToTabMOTD, NavigateToTabValue) == 0x0000B0, "Member 'FNavigateToTabMOTD::NavigateToTabValue' has a wrong offset!");
static_assert(offsetof(FNavigateToTabMOTD, NavigateToTabButtonText) == 0x0000B8, "Member 'FNavigateToTabMOTD::NavigateToTabButtonText' has a wrong offset!");
...
{
public:
	EItemShopNavigationAction                     OfferAction;                                       // 0x00B0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 OfferId;                                           // 0x00B8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FItemMOTD) == 0x000008, "Wrong alignment on FItemMOTD");
static_assert(sizeof(FItemMOTD) == 0x0000C8, "Wrong size on FItemMOTD");
static_assert(offsetof(FItemMOTD, OfferAction) == 0x0000B0, "Member 'FItemMOTD::OfferAction' has a wrong offset!");
static_assert(offsetof(FItemMOTD, OfferId) == 0x0000B8, "Member 'FItemMOTD::OfferId' has a wrong offset!");
...
static_assert(sizeof(FSettingsMOTD) == 0x0000D0, "Wrong size on FSettingsMOTD");
...
{
public:
	class FString                                 WebsiteURL;                                        // 0x00B0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 WebsiteButtonText;                                 // 0x00C0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWebsiteMOTD) == 0x000008, "Wrong alignment on FWebsiteMOTD");
static_assert(sizeof(FWebsiteMOTD) == 0x0000D0, "Wrong size on FWebsiteMOTD");
static_assert(offsetof(FWebsiteMOTD, WebsiteURL) == 0x0000B0, "Member 'FWebsiteMOTD::WebsiteURL' has a wrong offset!");
static_assert(offsetof(FWebsiteMOTD, WebsiteButtonText) == 0x0000C0, "Member 'FWebsiteMOTD::WebsiteButtonText' has a wrong offset!");
...
static_assert(sizeof(FAthenaItemShopSectionData) == 0x000038, "Wrong size on FAthenaItemShopSectionData");
...
public:
	...
	struct FGameplayTag                           ExcludeTag;                                        // 0x0028(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDefaultEntry;                                     // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRewardCategoryTabData) == 0x000008, "Wrong alignment on FRewardCategoryTabData");
static_assert(sizeof(FRewardCategoryTabData) == 0x000038, "Wrong size on FRewardCategoryTabData");
...
static_assert(offsetof(FRewardCategoryTabData, IncludeTag) == 0x000020, "Member 'FRewardCategoryTabData::IncludeTag' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, ExcludeTag) == 0x000028, "Member 'FRewardCategoryTabData::ExcludeTag' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, bDefaultEntry) == 0x000030, "Member 'FRewardCategoryTabData::bDefaultEntry' has a wrong offset!");
...
public:
	...
	EAtheaMapTabType                              TabType;                                           // 0x006A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, TabType) == 0x00006A, "Member 'FAthenaMapScreenContainerTabInfo::TabType' has a wrong offset!");
...
static_assert(sizeof(FAthenaEmergencyNotice) == 0x000028, "Wrong size on FAthenaEmergencyNotice");
...
// ScriptStruct FortniteUI.MOTDVideoParameters
// 0x0068 (0x0068 - 0x0000)
struct FMOTDVideoParameters final
{
public:
	class FString                                 VideoUID;                                          // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoVideoString;                                  // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoLoop;                                         // 0x0020(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoMute;                                         // 0x0021(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoStreamingEnabled;                             // 0x0022(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoAutoplay;                                     // 0x0023(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoFullscreen;                                   // 0x0024(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 VideoStreamingVideoID;                             // 0x0028(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoFallbackVideoID;                              // 0x0038(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoProdLinkID;                                   // 0x0048(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoGamedevLinkID;                                // 0x0058(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMOTDVideoParameters) == 0x000008, "Wrong alignment on FMOTDVideoParameters");
static_assert(sizeof(FMOTDVideoParameters) == 0x000068, "Wrong size on FMOTDVideoParameters");
static_assert(offsetof(FMOTDVideoParameters, VideoUID) == 0x000000, "Member 'FMOTDVideoParameters::VideoUID' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoVideoString) == 0x000010, "Member 'FMOTDVideoParameters::VideoVideoString' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoLoop) == 0x000020, "Member 'FMOTDVideoParameters::VideoLoop' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoMute) == 0x000021, "Member 'FMOTDVideoParameters::VideoMute' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoStreamingEnabled) == 0x000022, "Member 'FMOTDVideoParameters::VideoStreamingEnabled' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoAutoplay) == 0x000023, "Member 'FMOTDVideoParameters::VideoAutoplay' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoFullscreen) == 0x000024, "Member 'FMOTDVideoParameters::VideoFullscreen' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoStreamingVideoID) == 0x000028, "Member 'FMOTDVideoParameters::VideoStreamingVideoID' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoFallbackVideoID) == 0x000038, "Member 'FMOTDVideoParameters::VideoFallbackVideoID' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoProdLinkID) == 0x000048, "Member 'FMOTDVideoParameters::VideoProdLinkID' has a wrong offset!");
static_assert(offsetof(FMOTDVideoParameters, VideoGamedevLinkID) == 0x000058, "Member 'FMOTDVideoParameters::VideoGamedevLinkID' has a wrong offset!");

// ScriptStruct FortniteUI.TextWithVideoMOTD
// 0x0068 (0x0118 - 0x00B0)
struct FTextWithVideoMOTD final : public FAthenaMOTDBase
{
public:
	struct FMOTDVideoParameters                   VideoParameters;                                   // 0x00B0(0x0068)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTextWithVideoMOTD) == 0x000008, "Wrong alignment on FTextWithVideoMOTD");
static_assert(sizeof(FTextWithVideoMOTD) == 0x000118, "Wrong size on FTextWithVideoMOTD");
static_assert(offsetof(FTextWithVideoMOTD, VideoParameters) == 0x0000B0, "Member 'FTextWithVideoMOTD::VideoParameters' has a wrong offset!");

// ScriptStruct FortniteUI.ItemWithVideoMOTD
// 0x0068 (0x0130 - 0x00C8)
struct FItemWithVideoMOTD final : public FItemMOTD
{
public:
	struct FMOTDVideoParameters                   VideoParameters;                                   // 0x00C8(0x0068)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FItemWithVideoMOTD) == 0x000008, "Wrong alignment on FItemWithVideoMOTD");
static_assert(sizeof(FItemWithVideoMOTD) == 0x000130, "Wrong size on FItemWithVideoMOTD");
static_assert(offsetof(FItemWithVideoMOTD, VideoParameters) == 0x0000C8, "Member 'FItemWithVideoMOTD::VideoParameters' has a wrong offset!");

// ScriptStruct FortniteUI.WebsiteWithVideoMOTD
// 0x0068 (0x0138 - 0x00D0)
struct FWebsiteWithVideoMOTD final : public FWebsiteMOTD
{
public:
	struct FMOTDVideoParameters                   VideoParameters;                                   // 0x00D0(0x0068)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWebsiteWithVideoMOTD) == 0x000008, "Wrong alignment on FWebsiteWithVideoMOTD");
static_assert(sizeof(FWebsiteWithVideoMOTD) == 0x000138, "Wrong size on FWebsiteWithVideoMOTD");
static_assert(offsetof(FWebsiteWithVideoMOTD, VideoParameters) == 0x0000D0, "Member 'FWebsiteWithVideoMOTD::VideoParameters' has a wrong offset!");
...
{
public:
	class FString                                 PlaylistId;                                        // 0x00B0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPlaylistMOTD) == 0x000008, "Wrong alignment on FPlaylistMOTD");
static_assert(sizeof(FPlaylistMOTD) == 0x0000C0, "Wrong size on FPlaylistMOTD");
static_assert(offsetof(FPlaylistMOTD, PlaylistId) == 0x0000B0, "Member 'FPlaylistMOTD::PlaylistId' has a wrong offset!");
...
static_assert(sizeof(FSpatialScreenMOTD) == 0x0000C0, "Wrong size on FSpatialScreenMOTD");
...
{
public:
	class FString                                 ChallengeCategoryTag;                              // 0x00B0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChallengeMOTD) == 0x000008, "Wrong alignment on FChallengeMOTD");
static_assert(sizeof(FChallengeMOTD) == 0x0000C0, "Wrong size on FChallengeMOTD");
static_assert(offsetof(FChallengeMOTD, ChallengeCategoryTag) == 0x0000B0, "Member 'FChallengeMOTD::ChallengeCategoryTag' has a wrong offset!");
...
public:
	...
	int32                                         RefundValue;                                       // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaCrewPackItem) == 0x000008, "Wrong alignment on FAthenaCrewPackItem");
static_assert(sizeof(FAthenaCrewPackItem) == 0x000018, "Wrong size on FAthenaCrewPackItem");
static_assert(offsetof(FAthenaCrewPackItem, TemplateId) == 0x000000, "Member 'FAthenaCrewPackItem::TemplateId' has a wrong offset!");
static_assert(offsetof(FAthenaCrewPackItem, RefundValue) == 0x000010, "Member 'FAthenaCrewPackItem::RefundValue' has a wrong offset!");

// ScriptStruct FortniteUI.AthenaSubscriptionMonthlyRewards
// 0x00F8 (0x00F8 - 0x0000)
struct FAthenaSubscriptionMonthlyRewards final
{
public:
	...
	class FText                                   MtxTitle;                                          // 0x0028(0x0018)(NativeAccessSpecifierPublic)
	class FString                                 BattlepassImageURL;                                // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   BattlepassTitle;                                   // 0x0050(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BattlepassDescription;                             // 0x0068(0x0018)(NativeAccessSpecifierPublic)
	class FString                                 ColorA;                                            // 0x0080(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ColorB;                                            // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ColorC;                                            // 0x00A0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FAthenaCrewPackItem>            RemovedCrewPackItems;                              // 0x00B0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ItemShopTileImageURL;                              // 0x00C0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   ItemShopTileViolatorText;                          // 0x00D0(0x0018)(NativeAccessSpecifierPublic)
	EViolatorIntensity                            ItemShopTileViolatorIntensity;                     // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              CrewPackDateOverride;                              // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionMonthlyRewards) == 0x000008, "Wrong alignment on FAthenaSubscriptionMonthlyRewards");
static_assert(sizeof(FAthenaSubscriptionMonthlyRewards) == 0x0000F8, "Wrong size on FAthenaSubscriptionMonthlyRewards");
...
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, MtxTitle) == 0x000028, "Member 'FAthenaSubscriptionMonthlyRewards::MtxTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassImageURL) == 0x000040, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassTitle) == 0x000050, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassDescription) == 0x000068, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorA) == 0x000080, "Member 'FAthenaSubscriptionMonthlyRewards::ColorA' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorB) == 0x000090, "Member 'FAthenaSubscriptionMonthlyRewards::ColorB' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorC) == 0x0000A0, "Member 'FAthenaSubscriptionMonthlyRewards::ColorC' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, RemovedCrewPackItems) == 0x0000B0, "Member 'FAthenaSubscriptionMonthlyRewards::RemovedCrewPackItems' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileImageURL) == 0x0000C0, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileViolatorText) == 0x0000D0, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileViolatorText' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileViolatorIntensity) == 0x0000E8, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileViolatorIntensity' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, CrewPackDateOverride) == 0x0000F0, "Member 'FAthenaSubscriptionMonthlyRewards::CrewPackDateOverride' has a wrong offset!");
...
static_assert(sizeof(FAthenaSubscriptionPurchaseDetails) == 0x000098, "Wrong size on FAthenaSubscriptionPurchaseDetails");
...
public:
	...
	TArray<class FText>                           Entries;                                           // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FSubscriptionModalInfo>         Modals;                                            // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FAthenaSubscriptionMonthlyRewards      CurrentRewards;                                    // 0x0000(0x00F8)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionMonthlyRewards      NextRewards;                                       // 0x00F8(0x00F8)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionPurchaseDetails     PurchaseSubscriptionDetails;                       // 0x01F0(0x0098)(NativeAccessSpecifierPublic)
	class FText                                   SubscriptionDisclaimer;                            // 0x0288(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BlockedBenefitsNotice;                             // 0x02A0(0x0018)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x02B8(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionInfo) == 0x000008, "Wrong alignment on FAthenaSubscriptionInfo");
static_assert(sizeof(FAthenaSubscriptionInfo) == 0x0002C8, "Wrong size on FAthenaSubscriptionInfo");
...
static_assert(offsetof(FAthenaSubscriptionInfo, NextRewards) == 0x0000F8, "Member 'FAthenaSubscriptionInfo::NextRewards' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, PurchaseSubscriptionDetails) == 0x0001F0, "Member 'FAthenaSubscriptionInfo::PurchaseSubscriptionDetails' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, SubscriptionDisclaimer) == 0x000288, "Member 'FAthenaSubscriptionInfo::SubscriptionDisclaimer' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, BlockedBenefitsNotice) == 0x0002A0, "Member 'FAthenaSubscriptionInfo::BlockedBenefitsNotice' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, SubModals) == 0x0002B8, "Member 'FAthenaSubscriptionInfo::SubModals' has a wrong offset!");
...
static_assert(sizeof(FAthenaShopSection) == 0x000080, "Wrong size on FAthenaShopSection");
