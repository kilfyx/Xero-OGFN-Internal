...
public:
	...
	struct FDynamicQuestUpdateInfo                K2Node_MakeStruct_DynamicQuestUpdateInfo;          // 0x0058(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AFortPlayerController*>          K2Node_MakeArray_Array;                            // 0x0088(0x0010)(ReferenceParm)
};
