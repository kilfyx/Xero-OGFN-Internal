...
static_assert(sizeof(UItemAttributesDetailWidget_C) == 0x0002F0, "Wrong size on UItemAttributesDetailWidget_C");
static_assert(offsetof(UItemAttributesDetailWidget_C, UberGraphFrame) == 0x0002E0, "Member 'UItemAttributesDetailWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemAttributesDetailWidget_C, StatsListWidget) == 0x0002E8, "Member 'UItemAttributesDetailWidget_C::StatsListWidget' has a wrong offset!");
