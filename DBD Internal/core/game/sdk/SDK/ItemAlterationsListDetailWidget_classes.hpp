...
static_assert(sizeof(UItemAlterationsListDetailWidget_C) == 0x0002F0, "Wrong size on UItemAlterationsListDetailWidget_C");
static_assert(offsetof(UItemAlterationsListDetailWidget_C, UberGraphFrame) == 0x0002E0, "Member 'UItemAlterationsListDetailWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemAlterationsListDetailWidget_C, AlterationsWidget) == 0x0002E8, "Member 'UItemAlterationsListDetailWidget_C::AlterationsWidget' has a wrong offset!");
