...
// Package: GCN_ValetMod_OffRoadTire_HitGround

#include "Basic.hpp"

#include "GCN_ValetMod_OffRoadTire_HitGround_classes.hpp"
#include "GCN_ValetMod_OffRoadTire_HitGround_parameters.hpp"


namespace SDK
{

// Function GCN_ValetMod_OffRoadTire_HitGround.GCN_ValetMod_OffRoadTire_HitGround_C.OnBurstNiagara
...
void UGCN_ValetMod_OffRoadTire_HitGround_C::OnBurstNiagara(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UNiagaraComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_ValetMod_OffRoadTire_HitGround_C", "OnBurstNiagara");

	Params::GCN_ValetMod_OffRoadTire_HitGround_C_OnBurstNiagara Parms{};
