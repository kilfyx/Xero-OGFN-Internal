...
{
public:
	uint8                                         Pad_1B00[0x50];                                    // 0x1B00(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B54[0x4C];                                    // 0x1B54(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001BA0, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001B50, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x000754, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x000764, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000768, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x00076C, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000770, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x000778, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x000780, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ResolutionConnectionTimeout) == 0x000784, "Member 'UIpNetDriver::ResolutionConnectionTimeout' has a wrong offset!");
...
static_assert(sizeof(UOnlineEngineInterfaceImpl2) == 0x000128, "Wrong size on UOnlineEngineInterfaceImpl2");
static_assert(offsetof(UOnlineEngineInterfaceImpl2, VoiceSubsystemNameOverride) == 0x000028, "Member 'UOnlineEngineInterfaceImpl2::VoiceSubsystemNameOverride' has a wrong offset!");
