...
static_assert(sizeof(UFloatingInteraction_Indicator_S13_Punchcard_C) == 0x000398, "Wrong size on UFloatingInteraction_Indicator_S13_Punchcard_C");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, UberGraphFrame) == 0x0002B8, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, LoopingHoverState) == 0x0002C0, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::LoopingHoverState' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Unhover) == 0x0002C8, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Unhover' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Hover) == 0x0002D0, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Hover' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, PopluateIn) == 0x0002D8, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::PopluateIn' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Arrow) == 0x0002E0, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Arrow' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, CircleBurst) == 0x0002E8, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::CircleBurst' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, DigitalPattern) == 0x0002F0, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::DigitalPattern' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Divider) == 0x0002F8, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Divider' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, FloatingPip) == 0x000300, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::FloatingPip' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, InputActionMask) == 0x000308, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::InputActionMask' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, InputActionRing) == 0x000310, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::InputActionRing' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, InputActionWidget) == 0x000318, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::InputActionWidget' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, OverlayLeft) == 0x000320, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::OverlayLeft' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, OverlayRight) == 0x000328, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::OverlayRight' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, SafeZone_0) == 0x000330, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Select) == 0x000338, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Select' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, SelectionStateBox) == 0x000340, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::SelectionStateBox' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, NoBang) == 0x000348, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::NoBang' has a wrong offset!");
static_assert(offsetof(UFloatingInteraction_Indicator_S13_Punchcard_C, Bang) == 0x000370, "Member 'UFloatingInteraction_Indicator_S13_Punchcard_C::Bang' has a wrong offset!");
