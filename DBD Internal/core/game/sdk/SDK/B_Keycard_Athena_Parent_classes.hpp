...
static_assert(sizeof(AB_Keycard_Athena_Parent_C) == 0x000D20, "Wrong size on AB_Keycard_Athena_Parent_C");
static_assert(offsetof(AB_Keycard_Athena_Parent_C, StaticMesh) == 0x000D18, "Member 'AB_Keycard_Athena_Parent_C::StaticMesh' has a wrong offset!");
