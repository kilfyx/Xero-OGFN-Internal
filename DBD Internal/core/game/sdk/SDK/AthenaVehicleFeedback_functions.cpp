...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    PIPIsBlocking                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaVehicleFeedback_C::OnPiPBlockPlayer(bool PIPIsBlocking)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaVehicleFeedback_C", "OnPiPBlockPlayer");

	Params::AthenaVehicleFeedback_C_OnPiPBlockPlayer Parms{};

	Parms.PIPIsBlocking = PIPIsBlocking;
...
void UAthenaVehicleFeedback_C::OnLocalChallengesVisibilityChanged(bool bIsVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaVehicleFeedback_C", "OnLocalChallengesVisibilityChanged");

	Params::AthenaVehicleFeedback_C_OnLocalChallengesVisibilityChanged Parms{};
