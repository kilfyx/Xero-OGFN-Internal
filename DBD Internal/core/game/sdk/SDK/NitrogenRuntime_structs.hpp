...
enum class ENitrogenScoreReason : uint8
{
	...
	FareReward_Bonus_RunoverPedestrian       = 11,
	FareReward_Bonus_DriveReverse            = 12,
	FareReward_Bonus_Powerslide              = 13,
	ENitrogenScoreReason_MAX                 = 14,
};
...
public:
	...
	struct FScalableFloat                         MapIconScale;                                      // 0x0088(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenMapIcon) == 0x000008, "Wrong alignment on FNitrogenMapIcon");
static_assert(sizeof(FNitrogenMapIcon) == 0x0000B0, "Wrong size on FNitrogenMapIcon");
...
{
public:
	struct FNitrogenMapIcon                       PlacementMapIcon;                                  // 0x0000(0x00B0)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenMapIcon                       SquadmatePlacementMapIcon;                         // 0x00B0(0x00B0)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MinimumTeamScoreToShow;                            // 0x0160(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenMapPlacementIcon) == 0x000008, "Wrong alignment on FNitrogenMapPlacementIcon");
static_assert(sizeof(FNitrogenMapPlacementIcon) == 0x000188, "Wrong size on FNitrogenMapPlacementIcon");
...
static_assert(offsetof(FNitrogenMapPlacementIcon, SquadmatePlacementMapIcon) == 0x0000B0, "Member 'FNitrogenMapPlacementIcon::SquadmatePlacementMapIcon' has a wrong offset!");
static_assert(offsetof(FNitrogenMapPlacementIcon, MinimumTeamScoreToShow) == 0x000160, "Member 'FNitrogenMapPlacementIcon::MinimumTeamScoreToShow' has a wrong offset!");
...
public:
	...
	class UFortWorldItemDefinition*               PickupItemDef;                                     // 0x0028(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ANitrogenPickup>            PickupClass;                                       // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         TimeBeforeDespawn;                                 // 0x0038(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         bHidePickupForDyingPlayerTeam;                     // 0x0060(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FScalableFloat>                 PlacementBasedPickupDropCount;                     // 0x0088(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         TossDistance;                                      // 0x0098(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MinTeamScoreRequiredToDrop;                        // 0x00C0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenPickupItemToDropOnDeath) == 0x000008, "Wrong alignment on FNitrogenPickupItemToDropOnDeath");
static_assert(sizeof(FNitrogenPickupItemToDropOnDeath) == 0x0000E8, "Wrong size on FNitrogenPickupItemToDropOnDeath");
...
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, PickupItemDef) == 0x000028, "Member 'FNitrogenPickupItemToDropOnDeath::PickupItemDef' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, PickupClass) == 0x000030, "Member 'FNitrogenPickupItemToDropOnDeath::PickupClass' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, TimeBeforeDespawn) == 0x000038, "Member 'FNitrogenPickupItemToDropOnDeath::TimeBeforeDespawn' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, bHidePickupForDyingPlayerTeam) == 0x000060, "Member 'FNitrogenPickupItemToDropOnDeath::bHidePickupForDyingPlayerTeam' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, PlacementBasedPickupDropCount) == 0x000088, "Member 'FNitrogenPickupItemToDropOnDeath::PlacementBasedPickupDropCount' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, TossDistance) == 0x000098, "Member 'FNitrogenPickupItemToDropOnDeath::TossDistance' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupItemToDropOnDeath, MinTeamScoreRequiredToDrop) == 0x0000C0, "Member 'FNitrogenPickupItemToDropOnDeath::MinTeamScoreRequiredToDrop' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         SelectionWeight;                                   // 0x0008(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MinValue;                                          // 0x0030(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MaxValue;                                          // 0x0058(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TSubclassOf<class ANitrogenPickup>            PickupClass;                                       // 0x0080(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortWorldItemDefinition*               PickupItemDef;                                     // 0x0088(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenPickupCashbagData) == 0x000008, "Wrong alignment on FNitrogenPickupCashbagData");
static_assert(sizeof(FNitrogenPickupCashbagData) == 0x000090, "Wrong size on FNitrogenPickupCashbagData");
...
static_assert(offsetof(FNitrogenPickupCashbagData, MinValue) == 0x000030, "Member 'FNitrogenPickupCashbagData::MinValue' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupCashbagData, MaxValue) == 0x000058, "Member 'FNitrogenPickupCashbagData::MaxValue' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupCashbagData, PickupClass) == 0x000080, "Member 'FNitrogenPickupCashbagData::PickupClass' has a wrong offset!");
static_assert(offsetof(FNitrogenPickupCashbagData, PickupItemDef) == 0x000088, "Member 'FNitrogenPickupCashbagData::PickupItemDef' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         FareValue;                                         // 0x0008(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         bEnabled;                                          // 0x0030(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MaxFares;                                          // 0x0058(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenPOIConnectionData) == 0x000008, "Wrong alignment on FNitrogenPOIConnectionData");
static_assert(sizeof(FNitrogenPOIConnectionData) == 0x000080, "Wrong size on FNitrogenPOIConnectionData");
...
static_assert(offsetof(FNitrogenPOIConnectionData, bEnabled) == 0x000030, "Member 'FNitrogenPOIConnectionData::bEnabled' has a wrong offset!");
static_assert(offsetof(FNitrogenPOIConnectionData, MaxFares) == 0x000058, "Member 'FNitrogenPOIConnectionData::MaxFares' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         FareValue;                                         // 0x0000(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MinimumDistance;                                   // 0x0028(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         NumFares;                                          // 0x0050(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNitrogenFareDistanceValue) == 0x000008, "Wrong alignment on FNitrogenFareDistanceValue");
static_assert(sizeof(FNitrogenFareDistanceValue) == 0x000078, "Wrong size on FNitrogenFareDistanceValue");
...
static_assert(offsetof(FNitrogenFareDistanceValue, MinimumDistance) == 0x000028, "Member 'FNitrogenFareDistanceValue::MinimumDistance' has a wrong offset!");
static_assert(offsetof(FNitrogenFareDistanceValue, NumFares) == 0x000050, "Member 'FNitrogenFareDistanceValue::NumFares' has a wrong offset!");
...
public:
	struct FScalableFloat                         bEnabled;                                          // 0x0000(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TMap<struct FGameplayTag, struct FNitrogenPOICombinationData> POICombinationMap;                 // 0x0028(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	EFareGenerationMethod                         FareGenerationMethod;                              // 0x0078(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNitrogenPOICombinationMap) == 0x000008, "Wrong alignment on FNitrogenPOICombinationMap");
static_assert(sizeof(FNitrogenPOICombinationMap) == 0x000080, "Wrong size on FNitrogenPOICombinationMap");
...
static_assert(offsetof(FNitrogenPOICombinationMap, POICombinationMap) == 0x000028, "Member 'FNitrogenPOICombinationMap::POICombinationMap' has a wrong offset!");
static_assert(offsetof(FNitrogenPOICombinationMap, FareGenerationMethod) == 0x000078, "Member 'FNitrogenPOICombinationMap::FareGenerationMethod' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         bEnabled;                                          // 0x0008(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FNitrogenPlayerGameplayAbilityOption) == 0x000030, "Wrong size on FNitrogenPlayerGameplayAbilityOption");
...
{
public:
	struct FScalableFloat                         bEnabled;                                          // 0x0000(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         SpawnWeighting;                                    // 0x0028(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	int32                                         AwardPoints;                                       // 0x0050(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENitrogenBonusCondition                       AwardCondition;                                    // 0x0054(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENitrogenScoreReason                          ScoreReason;                                       // 0x0055(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_56[0x2];                                       // 0x0056(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Name;                                              // 0x0058(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	class FText                                   MustMeetGoal_BonusCompleteDescription;             // 0x0088(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	class FText                                   MustNotExceedThreshold_BonusFailureDescription;    // 0x00A0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TSubclassOf<class UFortAthenaAISpawnerDataComponent_CosmeticLoadout> CosmeticLoadoutData;        // 0x00B8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             TipEmojiTexture;                                   // 0x00C0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             FarePortraitTexture;                               // 0x00C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Goal;                                              // 0x00D0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         Threshold;                                         // 0x00F8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<class AFortPlayerState*, float>          Values;                                            // 0x0120(0x0050)(NativeAccessSpecifierPrivate)
};
static_assert(alignof(FNitrogenBonusStat) == 0x000008, "Wrong alignment on FNitrogenBonusStat");
static_assert(sizeof(FNitrogenBonusStat) == 0x000170, "Wrong size on FNitrogenBonusStat");
static_assert(offsetof(FNitrogenBonusStat, bEnabled) == 0x000000, "Member 'FNitrogenBonusStat::bEnabled' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, SpawnWeighting) == 0x000028, "Member 'FNitrogenBonusStat::SpawnWeighting' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, AwardPoints) == 0x000050, "Member 'FNitrogenBonusStat::AwardPoints' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, AwardCondition) == 0x000054, "Member 'FNitrogenBonusStat::AwardCondition' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, ScoreReason) == 0x000055, "Member 'FNitrogenBonusStat::ScoreReason' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, Name) == 0x000058, "Member 'FNitrogenBonusStat::Name' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, Description) == 0x000070, "Member 'FNitrogenBonusStat::Description' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, MustMeetGoal_BonusCompleteDescription) == 0x000088, "Member 'FNitrogenBonusStat::MustMeetGoal_BonusCompleteDescription' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, MustNotExceedThreshold_BonusFailureDescription) == 0x0000A0, "Member 'FNitrogenBonusStat::MustNotExceedThreshold_BonusFailureDescription' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, CosmeticLoadoutData) == 0x0000B8, "Member 'FNitrogenBonusStat::CosmeticLoadoutData' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, TipEmojiTexture) == 0x0000C0, "Member 'FNitrogenBonusStat::TipEmojiTexture' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, FarePortraitTexture) == 0x0000C8, "Member 'FNitrogenBonusStat::FarePortraitTexture' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, Goal) == 0x0000D0, "Member 'FNitrogenBonusStat::Goal' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, Threshold) == 0x0000F8, "Member 'FNitrogenBonusStat::Threshold' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStat, Values) == 0x000120, "Member 'FNitrogenBonusStat::Values' has a wrong offset!");
...
{
public:
	struct FNitrogenBonusStat                     VehicleBumpIntoVehicles;                           // 0x0000(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleBuildingDestruction;                        // 0x0170(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleDamageTaken;                                // 0x02E0(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleAirTime;                                    // 0x0450(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleBoostDrivingTime;                           // 0x05C0(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleOffRoadTime;                                // 0x0730(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleRunoverPedestrian;                          // 0x08A0(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehicleReverseDrivingTime;                         // 0x0A10(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FNitrogenBonusStat                     VehiclePowerslideTime;                             // 0x0B80(0x0170)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNitrogenBonusStats) == 0x000D08, "Wrong size on FNitrogenBonusStats");
...
static_assert(offsetof(FNitrogenBonusStats, VehicleBuildingDestruction) == 0x000170, "Member 'FNitrogenBonusStats::VehicleBuildingDestruction' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleDamageTaken) == 0x0002E0, "Member 'FNitrogenBonusStats::VehicleDamageTaken' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleAirTime) == 0x000450, "Member 'FNitrogenBonusStats::VehicleAirTime' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleBoostDrivingTime) == 0x0005C0, "Member 'FNitrogenBonusStats::VehicleBoostDrivingTime' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleOffRoadTime) == 0x000730, "Member 'FNitrogenBonusStats::VehicleOffRoadTime' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleRunoverPedestrian) == 0x0008A0, "Member 'FNitrogenBonusStats::VehicleRunoverPedestrian' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehicleReverseDrivingTime) == 0x000A10, "Member 'FNitrogenBonusStats::VehicleReverseDrivingTime' has a wrong offset!");
static_assert(offsetof(FNitrogenBonusStats, VehiclePowerslideTime) == 0x000B80, "Member 'FNitrogenBonusStats::VehiclePowerslideTime' has a wrong offset!");
