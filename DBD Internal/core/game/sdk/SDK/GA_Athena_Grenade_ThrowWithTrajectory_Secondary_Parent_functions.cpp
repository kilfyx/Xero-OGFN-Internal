...
void UGA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C::AddValidCamera()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C", "AddValidCamera");
...
bool UGA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C::K2_CanActivateAbility(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayAbilitySpecHandle& Handle, struct FGameplayTagContainer* RelevantTags) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C", "K2_CanActivateAbility");

	Params::GA_Athena_Grenade_ThrowWithTrajectory_Secondary_Parent_C_K2_CanActivateAbility Parms{};
