...
void AB_Prj_Athena_StickyGrenade_C::AIDiedEvent(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation_0, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::B_Prj_Athena_StickyGrenade_C_AIDiedEvent Parms{};
...
void AB_Prj_Athena_StickyGrenade_C::BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_2_WaterInteractionOnEnterWater__DelegateSignature(class AFortWaterBodyActor* WaterBody, class UFortWaterInteractionComponent* WaterInteractionComponent_0, bool bIsFirstBody)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_2_WaterInteractionOnEnterWater__DelegateSignature");

	Params::B_Prj_Athena_StickyGrenade_C_BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_2_WaterInteractionOnEnterWater__DelegateSignature Parms{};
...
// Function B_Prj_Athena_StickyGrenade.B_Prj_Athena_StickyGrenade_C.CallExplodeTrigger
// (BlueprintCallable, BlueprintEvent)

void AB_Prj_Athena_StickyGrenade_C::CallExplodeTrigger()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "CallExplodeTrigger");
...
// Function B_Prj_Athena_StickyGrenade.B_Prj_Athena_StickyGrenade_C.ForceBeep
// (BlueprintCallable, BlueprintEvent)

void AB_Prj_Athena_StickyGrenade_C::ForceBeep()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_StickyGrenade_C", "ForceBeep");
...
void AB_Prj_Athena_StickyGrenade_C::HandleHits(class UObject* Actor, class UPrimitiveComponent* Component)
{
	static class UFunction* Func = nullptr;
...
void AB_Prj_Athena_StickyGrenade_C::PlayerDiedEvent(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation_0, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Prj_Athena_StickyGrenade_C_PlayerDiedEvent Parms{};
