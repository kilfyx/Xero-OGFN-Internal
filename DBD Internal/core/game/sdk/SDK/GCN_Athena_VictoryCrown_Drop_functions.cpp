...
#include "GCN_Athena_VictoryCrown_Drop_classes.hpp"
#include "GCN_Athena_VictoryCrown_Drop_parameters.hpp"
...
void UGCN_Athena_VictoryCrown_Drop_C::GetSoundIndicatorMaxDistance(float* MaxDistance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_VictoryCrown_Drop_C", "GetSoundIndicatorMaxDistance");

	Params::GCN_Athena_VictoryCrown_Drop_C_GetSoundIndicatorMaxDistance Parms{};
...
void UGCN_Athena_VictoryCrown_Drop_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_VictoryCrown_Drop_C", "OnBurstGeneric");

	Params::GCN_Athena_VictoryCrown_Drop_C_OnBurstGeneric Parms{};
