...
static_assert(alignof(UBPWaveLIbrary_C) == 0x000008, "Wrong alignment on UBPWaveLIbrary_C");
static_assert(sizeof(UBPWaveLIbrary_C) == 0x000028, "Wrong size on UBPWaveLIbrary_C");
