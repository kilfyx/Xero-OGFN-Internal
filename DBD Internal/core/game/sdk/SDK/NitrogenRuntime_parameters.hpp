...
static_assert(sizeof(FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex) == 0x0000D8, "Wrong size on FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex");
...
static_assert(offsetof(FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex, TeleportReasonString) == 0x0000C8, "Member 'FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex::TeleportReasonString' has a wrong offset!");
...
static_assert(alignof(NitrogenTraversePoint_OnVehicleDriverChanged) == 0x000008, "Wrong alignment on NitrogenTraversePoint_OnVehicleDriverChanged");
static_assert(sizeof(NitrogenTraversePoint_OnVehicleDriverChanged) == 0x000010, "Wrong size on NitrogenTraversePoint_OnVehicleDriverChanged");
static_assert(offsetof(NitrogenTraversePoint_OnVehicleDriverChanged, NewController) == 0x000000, "Member 'NitrogenTraversePoint_OnVehicleDriverChanged::NewController' has a wrong offset!");
static_assert(offsetof(NitrogenTraversePoint_OnVehicleDriverChanged, Vehicle) == 0x000008, "Member 'NitrogenTraversePoint_OnVehicleDriverChanged::Vehicle' has a wrong offset!");
