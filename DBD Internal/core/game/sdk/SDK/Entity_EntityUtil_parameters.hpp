...
static_assert(alignof(EntityUtil_createAndAddComponent) == 0x000008, "Wrong alignment on EntityUtil_createAndAddComponent");
...
static_assert(alignof(EntityUtil_getComponentOfTypeFromComponent) == 0x000008, "Wrong alignment on EntityUtil_getComponentOfTypeFromComponent");
...
static_assert(alignof(EntityUtil_getComponentOfTypeFromComponentForEntity) == 0x000008, "Wrong alignment on EntityUtil_getComponentOfTypeFromComponentForEntity");
...
static_assert(alignof(EntityUtil_spawnEmptyEntity) == 0x000008, "Wrong alignment on EntityUtil_spawnEmptyEntity");
...
static_assert(alignof(EntityUtil_spawnEntityFromAsset) == 0x000008, "Wrong alignment on EntityUtil_spawnEntityFromAsset");
