...
public:
	...
	TDelegate<void(const class UAthenaMusicPackItemDefinition* NewMusicPack, float StartTimeOffset)> K2Node_CreateDelegate_OutputDelegate; // 0x005C(0x0010)(ZeroConstructor, NoDestructor)
