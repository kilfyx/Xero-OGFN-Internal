...
static_assert(sizeof(UGAT_DanceGrenade_C) == 0x000AD8, "Wrong size on UGAT_DanceGrenade_C");
static_assert(offsetof(UGAT_DanceGrenade_C, UberGraphFrame_GAT_DanceGrenade_C) == 0x000AD0, "Member 'UGAT_DanceGrenade_C::UberGraphFrame_GAT_DanceGrenade_C' has a wrong offset!");
