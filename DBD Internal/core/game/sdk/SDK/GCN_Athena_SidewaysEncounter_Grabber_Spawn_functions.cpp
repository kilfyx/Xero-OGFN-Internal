...
#include "GCN_Athena_SidewaysEncounter_Grabber_Spawn_classes.hpp"
#include "GCN_Athena_SidewaysEncounter_Grabber_Spawn_parameters.hpp"
...
void UGCN_Athena_SidewaysEncounter_Grabber_Spawn_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_SidewaysEncounter_Grabber_Spawn_C", "OnBurstGeneric");

	Params::GCN_Athena_SidewaysEncounter_Grabber_Spawn_C_OnBurstGeneric Parms{};
