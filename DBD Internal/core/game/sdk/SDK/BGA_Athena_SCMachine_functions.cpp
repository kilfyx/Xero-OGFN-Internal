...
void ABGA_Athena_SCMachine_C::HandlePlayerCountChanged(int32 InteractingPlayerCount, float MultiInteractMultiplier, float InteractingDuration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_Athena_SCMachine_C", "HandlePlayerCountChanged");

	Params::BGA_Athena_SCMachine_C_HandlePlayerCountChanged Parms{};
