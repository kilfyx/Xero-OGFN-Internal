...
// (Final, Native, Private)
// Parameters:
// const class AFortAthenaVehicle*         NewVehicle                                             (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UNitrogenObjectiveWidget::HandleVehicleEnteredDriverSeat(const class AFortAthenaVehicle* NewVehicle)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("NitrogenObjectiveWidget", "HandleVehicleEnteredDriverSeat");
...
void UNitrogenObjectiveWidget::HandleVehicleExitedDriverSeat()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("NitrogenObjectiveWidget", "HandleVehicleExitedDriverSeat");
