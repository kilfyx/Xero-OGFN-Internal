...
#include "GCN_Athena_Campsite_Tent_Hide_Heal_classes.hpp"
#include "GCN_Athena_Campsite_Tent_Hide_Heal_parameters.hpp"
...
void UGCN_Athena_Campsite_Tent_Hide_Heal_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Campsite_Tent_Hide_Heal_C", "OnBurstGeneric");

	Params::GCN_Athena_Campsite_Tent_Hide_Heal_C_OnBurstGeneric Parms{};
...
bool UGCN_Athena_Campsite_Tent_Hide_Heal_C::OnExecute(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Campsite_Tent_Hide_Heal_C", "OnExecute");

	Params::GCN_Athena_Campsite_Tent_Hide_Heal_C_OnExecute Parms{};
