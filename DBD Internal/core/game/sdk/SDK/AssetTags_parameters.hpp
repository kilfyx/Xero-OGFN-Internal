...
static_assert(sizeof(AssetTagsSubsystem_GetCollectionsContainingAssetData) == 0x000068, "Wrong size on AssetTagsSubsystem_GetCollectionsContainingAssetData");
...
static_assert(offsetof(AssetTagsSubsystem_GetCollectionsContainingAssetData, ReturnValue) == 0x000058, "Member 'AssetTagsSubsystem_GetCollectionsContainingAssetData::ReturnValue' has a wrong offset!");
