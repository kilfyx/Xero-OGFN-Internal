...
static_assert(sizeof(USimplePipButton_C) == 0x000BD8, "Wrong size on USimplePipButton_C");
...
static_assert(offsetof(USimplePipButton_C, InputActionHorizontalAlignment) == 0x000BC0, "Member 'USimplePipButton_C::InputActionHorizontalAlignment' has a wrong offset!");
static_assert(offsetof(USimplePipButton_C, InputActionVerticalAlignment) == 0x000BC1, "Member 'USimplePipButton_C::InputActionVerticalAlignment' has a wrong offset!");
static_assert(offsetof(USimplePipButton_C, InputActionRenderTranslation) == 0x000BC4, "Member 'USimplePipButton_C::InputActionRenderTranslation' has a wrong offset!");
static_assert(offsetof(USimplePipButton_C, InputActionUseRimBrush) == 0x000BCC, "Member 'USimplePipButton_C::InputActionUseRimBrush' has a wrong offset!");
static_assert(offsetof(USimplePipButton_C, InputActionRimBrushSize) == 0x000BD0, "Member 'USimplePipButton_C::InputActionRimBrushSize' has a wrong offset!");
