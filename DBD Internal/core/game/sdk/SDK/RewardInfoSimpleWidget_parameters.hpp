...
static_assert(sizeof(RewardInfoSimpleWidget_C_GetDisplayName) == 0x001048, "Wrong size on RewardInfoSimpleWidget_C_GetDisplayName");
...
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_MakeLiteralText_ReturnValue) == 0x000B48, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue) == 0x000B60, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData) == 0x000B68, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
...
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_MakeLiteralText_ReturnValue_1) == 0x000BB0, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_MakeLiteralText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue) == 0x000BC8, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData_1) == 0x000C48, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue_1) == 0x000C88, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData_2) == 0x000D08, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue_2) == 0x000D48, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData_3) == 0x000DC8, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData_3' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeArray_Array) == 0x000E08, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeArray_Array' has a wrong offset!");
...
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_Format_ReturnValue) == 0x000E58, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue_1) == 0x000E70, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_DynamicCast_AsFort_Worker) == 0x000E78, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_DynamicCast_AsFort_Worker' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_DynamicCast_bSuccess) == 0x000E80, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetFilterCategory_ReturnValue) == 0x000E81, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetFilterCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000E82, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue_2) == 0x000E88, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ItemCategoryText) == 0x000E90, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ItemCategoryText' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ItemCategoryBrush) == 0x000EA8, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ItemCategoryBrush' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ReturnValue) == 0x000F30, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue_3) == 0x000F38, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData_5) == 0x000F40, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData_5' has a wrong offset!");
...
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeArray_Array_1) == 0x000F88, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000F98, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_Format_ReturnValue_1) == 0x000FA0, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue_4) == 0x000FB8, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_GetType_ReturnValue_1) == 0x000FC0, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_GetType_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_Select_Default) == 0x000FC8, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData_6) == 0x000FE0, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData_6' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, K2Node_MakeArray_Array_2) == 0x001020, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::K2Node_MakeArray_Array_2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleWidget_C_GetDisplayName, CallFunc_Format_ReturnValue_2) == 0x001030, "Member 'RewardInfoSimpleWidget_C_GetDisplayName::CallFunc_Format_ReturnValue_2' has a wrong offset!");
