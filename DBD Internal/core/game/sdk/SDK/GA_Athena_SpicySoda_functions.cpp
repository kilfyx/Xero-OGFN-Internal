...
#include "GA_Athena_SpicySoda_classes.hpp"
#include "GA_Athena_SpicySoda_parameters.hpp"


namespace SDK
{

// Function GA_Athena_SpicySoda.GA_Athena_SpicySoda_C.ExecuteUbergraph_GA_Athena_SpicySoda
// (Final, UbergraphFunction)
// Parameters:
// int32                                   EntryPoint                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_Athena_SpicySoda_C::ExecuteUbergraph_GA_Athena_SpicySoda(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_SpicySoda_C", "ExecuteUbergraph_GA_Athena_SpicySoda");

	Params::GA_Athena_SpicySoda_C_ExecuteUbergraph_GA_Athena_SpicySoda Parms{};
...
// Function GA_Athena_SpicySoda.GA_Athena_SpicySoda_C.OnProjectileSpawned
...
void UGA_Athena_SpicySoda_C::OnProjectileSpawned(class AFortProjectileBase* SpawnedProjectile_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_SpicySoda_C", "OnProjectileSpawned");

	Params::GA_Athena_SpicySoda_C_OnProjectileSpawned Parms{};
...
// Function GA_Athena_SpicySoda.GA_Athena_SpicySoda_C.SpawnThrownProjectile
...
void UGA_Athena_SpicySoda_C::SpawnThrownProjectile(class UClass* ProjectileClass_0, const struct FVector& ProjectileSpawnLocation, const struct FRotator& ProjectileSpawnDirection, const struct FFortGameplayEffectContainerSpec& HitEffectContainerSpec_0, const struct FFortGameplayEffectContainerSpec& ExplosionEffectContainerSpec_0, float ProjectileInitialSpeed, float ProjectileGravityScale_0, class AFortProjectileBase** SpawnedProjectile_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_SpicySoda_C", "SpawnThrownProjectile");

	Params::GA_Athena_SpicySoda_C_SpawnThrownProjectile Parms{};
