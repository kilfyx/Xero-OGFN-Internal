...
static_assert(alignof(FGameplayMessageReceiverHandle) == 0x000004, "Wrong alignment on FGameplayMessageReceiverHandle");
static_assert(sizeof(FGameplayMessageReceiverHandle) == 0x000014, "Wrong size on FGameplayMessageReceiverHandle");
