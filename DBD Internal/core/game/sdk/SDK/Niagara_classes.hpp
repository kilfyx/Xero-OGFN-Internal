...
public:
	...
	uint8                                         Pad_521[0x2F];                                     // 0x0521(0x002F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_593[0x5D];                                     // 0x0593(0x005D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000554, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, EmitterMaterials) == 0x000558, "Member 'UNiagaraComponent::EmitterMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000570, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000580, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000588, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000590, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000591, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x000592, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
...
static_assert(sizeof(UNiagaraEffectType) == 0x000130, "Wrong size on UNiagaraEffectType");
...
static_assert(offsetof(UNiagaraEffectType, PerfBaselineStats) == 0x000110, "Member 'UNiagaraEffectType::PerfBaselineStats' has a wrong offset!");
static_assert(offsetof(UNiagaraEffectType, PerfBaselineVersion) == 0x000120, "Member 'UNiagaraEffectType::PerfBaselineVersion' has a wrong offset!");
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x0006D8, "Wrong size on UNiagaraMeshRendererProperties");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x0006C0, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x0006C8, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x0006D4, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
static_assert(sizeof(UNiagaraBaselineController) == 0x000048, "Wrong size on UNiagaraBaselineController");
...
static_assert(offsetof(UNiagaraBaselineController, System) == 0x000030, "Member 'UNiagaraBaselineController::System' has a wrong offset!");
...
static_assert(sizeof(UNiagaraBaselineController_Basic) == 0x000060, "Wrong size on UNiagaraBaselineController_Basic");
static_assert(offsetof(UNiagaraBaselineController_Basic, NumInstances) == 0x000048, "Member 'UNiagaraBaselineController_Basic::NumInstances' has a wrong offset!");
static_assert(offsetof(UNiagaraBaselineController_Basic, SpawnedComponents) == 0x000050, "Member 'UNiagaraBaselineController_Basic::SpawnedComponents' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuMaxInfluences) == 0x0000B2, "Member 'UNiagaraSettings::NDISkelMesh_GpuMaxInfluences' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuUniformSamplingFormat) == 0x0000B3, "Member 'UNiagaraSettings::NDISkelMesh_GpuUniformSamplingFormat' has a wrong offset!");
