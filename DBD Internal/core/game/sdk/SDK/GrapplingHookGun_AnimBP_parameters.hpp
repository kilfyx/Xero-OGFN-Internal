...
static_assert(sizeof(GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP) == 0x000088, "Wrong size on GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP");
...
static_assert(offsetof(GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP, K2Node_Event_DeltaTimeX) == 0x000064, "Member 'GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP::K2Node_Event_DeltaTimeX' has a wrong offset!");
