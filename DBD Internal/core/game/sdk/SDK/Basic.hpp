...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09718358;
	constexpr int32 AppendString      = 0x03696500;
	constexpr int32 GNames            = 0x096DBEC0;
	constexpr int32 GWorld            = 0x09854E80;
	constexpr int32 ProcessEvent      = 0x03894FF0;
