...
// Function HUD_XP_Pop_Widget.HUD_XP_Pop_Widget_C.BindToOutroFinished
// (BlueprintCallable, BlueprintEvent)

void UHUD_XP_Pop_Widget_C::BindToOutroFinished()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_XP_Pop_Widget_C", "BindToOutroFinished");
...
void UHUD_XP_Pop_Widget_C::UpdateXPAmount(int32 NewAmount, class USoundCue* Cue, const EFortSimulatedXPSize SimulatedXpSize)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const class FText&                      NewSourceText                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
