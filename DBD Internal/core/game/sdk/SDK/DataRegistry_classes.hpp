...
static_assert(sizeof(UDataRegistry) == 0x0000A8, "Wrong size on UDataRegistry");
...
static_assert(sizeof(UDataRegistrySubsystem) == 0x000118, "Wrong size on UDataRegistrySubsystem");
