...
static_assert(sizeof(ABGA_CurieFireMesh_MolotovCocktail_C) == 0x000880, "Wrong size on ABGA_CurieFireMesh_MolotovCocktail_C");
static_assert(offsetof(ABGA_CurieFireMesh_MolotovCocktail_C, SelfPropagationFuelRowValue) == 0x000858, "Member 'ABGA_CurieFireMesh_MolotovCocktail_C::SelfPropagationFuelRowValue' has a wrong offset!");
