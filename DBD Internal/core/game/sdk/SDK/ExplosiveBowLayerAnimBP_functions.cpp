...
void UExplosiveBowLayerAnimBP_C::ItemSwimJumpStart(struct FPoseLink* ItemSwimJumpStart_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ExplosiveBowLayerAnimBP_C", "ItemSwimJumpStart");

	Params::ExplosiveBowLayerAnimBP_C_ItemSwimJumpStart Parms{};
...
void UExplosiveBowLayerAnimBP_C::ItemSwimJumpStartLoop(struct FPoseLink* ItemSwimJumpStartLoop_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ExplosiveBowLayerAnimBP_C", "ItemSwimJumpStartLoop");

	Params::ExplosiveBowLayerAnimBP_C_ItemSwimJumpStartLoop Parms{};
...
void UExplosiveBowLayerAnimBP_C::ItemAimOffset(const struct FPoseLink& InPose_AimOffset, float AimOffsetAlpha, float Yaw, float Pitch, const struct FPoseLink& InPose_UpperLowerPreMeleeAO, struct FPoseLink* ItemAimOffset_0)
{
	static class UFunction* Func = nullptr;
