...
void UBadgerBangsLayerAnimBP_C::ItemSkeletalControl(const struct FPoseLink& InPose, struct FPoseLink* ItemSkeletalControl_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BadgerBangsLayerAnimBP_C", "ItemSkeletalControl");

	Params::BadgerBangsLayerAnimBP_C_ItemSkeletalControl Parms{};
...
void UBadgerBangsLayerAnimBP_C::ItemAimOffset(const struct FPoseLink& InPose_AimOffset, float AimOffsetAlpha, float Yaw, float Pitch, const struct FPoseLink& InPose_UpperLowerPreMeleeAO, struct FPoseLink* ItemAimOffset_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BadgerBangsLayerAnimBP_C", "ItemAimOffset");

	Params::BadgerBangsLayerAnimBP_C_ItemAimOffset Parms{};
...
void UBadgerBangsLayerAnimBP_C::ItemFullBodyOverride(const struct FPoseLink& InPoseFullBody, struct FPoseLink* ItemFullBodyOverride_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BadgerBangsLayerAnimBP_C", "ItemFullBodyOverride");

	Params::BadgerBangsLayerAnimBP_C_ItemFullBodyOverride Parms{};
...
void UBadgerBangsLayerAnimBP_C::ItemPreIK(const struct FPoseLink& InPose_PreIK, struct FPoseLink* ItemPreIK_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BadgerBangsLayerAnimBP_C", "ItemPreIK");

	Params::BadgerBangsLayerAnimBP_C_ItemPreIK Parms{};
