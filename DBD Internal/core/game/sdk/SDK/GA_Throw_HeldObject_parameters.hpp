...
public:
	...
	float                                         ProjectileGravityScale;                            // 0x00DC(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GA_Throw_HeldObject_C_SpawnThrownProjectile, ProjectileGravityScale) == 0x0000DC, "Member 'GA_Throw_HeldObject_C_SpawnThrownProjectile::ProjectileGravityScale' has a wrong offset!");
