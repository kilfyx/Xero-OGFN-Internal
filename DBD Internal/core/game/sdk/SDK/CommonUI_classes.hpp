...
static_assert(offsetof(UCommonVisibilityWidget, bShowForPS5) == 0x000296, "Member 'UCommonVisibilityWidget::bShowForPS5' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForXBox) == 0x000297, "Member 'UCommonVisibilityWidget::bShowForXBox' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForXSX) == 0x000298, "Member 'UCommonVisibilityWidget::bShowForXSX' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForIOS) == 0x000299, "Member 'UCommonVisibilityWidget::bShowForIOS' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForAndroid) == 0x00029A, "Member 'UCommonVisibilityWidget::bShowForAndroid' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, bShowForErebus) == 0x00029B, "Member 'UCommonVisibilityWidget::bShowForErebus' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, VisibleType) == 0x00029C, "Member 'UCommonVisibilityWidget::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidget, HiddenType) == 0x00029D, "Member 'UCommonVisibilityWidget::HiddenType' has a wrong offset!");
