...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Athena_ForagedItemVersion_Consume_Parent_C; // 0x0C70(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
