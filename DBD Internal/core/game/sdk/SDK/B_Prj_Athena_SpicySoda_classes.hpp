...
class AB_Prj_Athena_SpicySoda_C final : public AB_Prj_ThrownConsumable_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_Prj_Athena_SpicySoda_C;           // 0x0968(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	void ExecuteUbergraph_B_Prj_Athena_SpicySoda(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"B_Prj_Athena_SpicySoda_C">();
	}
	static class AB_Prj_Athena_SpicySoda_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AB_Prj_Athena_SpicySoda_C>();
	}
};
