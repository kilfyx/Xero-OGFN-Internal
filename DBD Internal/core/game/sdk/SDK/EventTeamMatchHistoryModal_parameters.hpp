...
static_assert(sizeof(EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style) == 0x0001D0, "Wrong size on EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style");
...
static_assert(offsetof(EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style, K2Node_MakeStruct_SlateColor) == 0x0001A8, "Member 'EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style::K2Node_MakeStruct_SlateColor' has a wrong offset!");
