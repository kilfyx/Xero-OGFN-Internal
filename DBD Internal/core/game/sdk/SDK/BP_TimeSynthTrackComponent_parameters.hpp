...
static_assert(sizeof(BP_TimeSynthTrackComponent_C_QueueTrackStart) == 0x000078, "Wrong size on BP_TimeSynthTrackComponent_C_QueueTrackStart");
...
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_GetGameStateAthena_ReturnValue) == 0x000018, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_GetGameStateAthena_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_GetAthenaPlaylistContextTags_ReturnValue) == 0x000020, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_GetAthenaPlaylistContextTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_CalculateMaxClipDuration_Duration) == 0x000040, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_CalculateMaxClipDuration_Duration' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_HasAnyTags_ReturnValue) == 0x000044, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_HasAnyTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_CheckPlaystate_Result) == 0x000045, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_CheckPlaystate_Result' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_IsValid_ReturnValue) == 0x000046, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_CheckPlaystate_Result_1) == 0x000047, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_CheckPlaystate_Result_1' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_BooleanOR_ReturnValue) == 0x000048, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_Array_Length_ReturnValue) == 0x00004C, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_Array_Get_Item) == 0x000050, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_Less_IntInt_ReturnValue) == 0x000060, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_PlayClip_ReturnValue) == 0x000064, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_PlayClip_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthTrackComponent_C_QueueTrackStart, CallFunc_Array_Add_ReturnValue) == 0x000070, "Member 'BP_TimeSynthTrackComponent_C_QueueTrackStart::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
