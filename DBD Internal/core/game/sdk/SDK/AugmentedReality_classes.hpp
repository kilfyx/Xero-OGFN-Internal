...
static_assert(sizeof(UARTexture) == 0x0000E8, "Wrong size on UARTexture");
static_assert(offsetof(UARTexture, TextureType) == 0x0000C8, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x0000CC, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x0000D0, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x0000E0, "Member 'UARTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTextureCameraImage) == 0x0000E8, "Wrong size on UARTextureCameraImage");
...
static_assert(sizeof(UARTextureCameraDepth) == 0x0000F0, "Wrong size on UARTextureCameraDepth");
static_assert(offsetof(UARTextureCameraDepth, DepthQuality) == 0x0000E8, "Member 'UARTextureCameraDepth::DepthQuality' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, DepthAccuracy) == 0x0000E9, "Member 'UARTextureCameraDepth::DepthAccuracy' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, bIsTemporallySmoothed) == 0x0000EA, "Member 'UARTextureCameraDepth::bIsTemporallySmoothed' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x000140, "Wrong size on UAREnvironmentCaptureProbeTexture");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000120, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Timestamp) == 0x000124, "Member 'UAREnvironmentCaptureProbeTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000128, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000138, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
