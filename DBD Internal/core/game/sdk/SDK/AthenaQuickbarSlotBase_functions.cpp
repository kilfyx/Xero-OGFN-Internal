...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    UseNative                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaQuickbarSlotBase_C::RemoveUnusedSlotVisual()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AthenaQuickbarSlotBase_C", "RemoveUnusedSlotVisual");
...
void UAthenaQuickbarSlotBase_C::OnExtensionWidgetAdded(const EUIExtensionSlot ExtensionSlot, class UUserWidget* ExtensionWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaQuickbarSlotBase_C", "OnExtensionWidgetAdded");

	Params::AthenaQuickbarSlotBase_C_OnExtensionWidgetAdded Parms{};
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bShouldSkipAnimation                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
