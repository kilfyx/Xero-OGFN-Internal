...
void UChatMessageEntry_C::OnFocusedChanged(bool bIsFocused)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFocusedChanged");
...
void UChatMessageEntry_C::OnEntryUpdated_1()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEntryUpdated_1");
...
void UChatMessageEntry_C::HandleSelectionStatusChanged(bool bIsSelected)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleSelectionStatusChanged");
...
void UChatMessageEntry_C::ExecuteUbergraph_ChatMessageEntry(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ChatMessageEntry");
...
void UChatMessageEntry_C::BndEvt__Button_FocusTarget_K2Node_ComponentBoundEvent_35_OnButtonClickedEvent__DelegateSignature()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__Button_FocusTarget_K2Node_ComponentBoundEvent_35_OnButtonClickedEvent__DelegateSignature");
