...
public:
	...
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_1;               // 0x0128(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
