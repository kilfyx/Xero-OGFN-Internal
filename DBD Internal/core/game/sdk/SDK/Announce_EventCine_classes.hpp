...
static_assert(sizeof(AAnnounce_EventCine_C) == 0x0002C8, "Wrong size on AAnnounce_EventCine_C");
static_assert(offsetof(AAnnounce_EventCine_C, UberGraphFrame) == 0x0002A0, "Member 'AAnnounce_EventCine_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_EventCine_C, DefaultSceneRoot) == 0x0002A8, "Member 'AAnnounce_EventCine_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AAnnounce_EventCine_C, EventMediaSource) == 0x0002B0, "Member 'AAnnounce_EventCine_C::EventMediaSource' has a wrong offset!");
static_assert(offsetof(AAnnounce_EventCine_C, AllowSkipping) == 0x0002B8, "Member 'AAnnounce_EventCine_C::AllowSkipping' has a wrong offset!");
static_assert(offsetof(AAnnounce_EventCine_C, EventSubtitlesPlayer) == 0x0002C0, "Member 'AAnnounce_EventCine_C::EventSubtitlesPlayer' has a wrong offset!");
