...
static_assert(sizeof(AB_BGA_Athena_CampFire_Trap_C) == 0x000AB0, "Wrong size on AB_BGA_Athena_CampFire_Trap_C");
static_assert(offsetof(AB_BGA_Athena_CampFire_Trap_C, UberGraphFrame_B_BGA_Athena_CampFire_Trap_C) == 0x000AA8, "Member 'AB_BGA_Athena_CampFire_Trap_C::UberGraphFrame_B_BGA_Athena_CampFire_Trap_C' has a wrong offset!");
