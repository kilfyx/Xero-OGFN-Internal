...
#include "GCN_Athena_HidingProp_Portapotty_Rustle_classes.hpp"
#include "GCN_Athena_HidingProp_Portapotty_Rustle_parameters.hpp"
...
void UGCN_Athena_HidingProp_Portapotty_Rustle_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_HidingProp_Portapotty_Rustle_C", "OnBurst");

	Params::GCN_Athena_HidingProp_Portapotty_Rustle_C_OnBurst Parms{};
