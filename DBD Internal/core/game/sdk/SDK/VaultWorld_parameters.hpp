...
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bShowFloor) == 0x000004, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bShowFloor' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bShowEffects) == 0x000005, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bShowEffects' has a wrong offset!");
