...
#include "GCN_Athena_Corruption_SpicySoda_Explode_classes.hpp"
#include "GCN_Athena_Corruption_SpicySoda_Explode_parameters.hpp"
...
void UGCN_Athena_Corruption_SpicySoda_Explode_C::ExecuteUbergraph_GCN_Athena_Corruption_SpicySoda_Explode(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Corruption_SpicySoda_Explode_C", "ExecuteUbergraph_GCN_Athena_Corruption_SpicySoda_Explode");

	Params::GCN_Athena_Corruption_SpicySoda_Explode_C_ExecuteUbergraph_GCN_Athena_Corruption_SpicySoda_Explode Parms{};
