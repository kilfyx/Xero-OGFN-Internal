...
#include "GCN_Athena_HidingProp_Tent_Rustle_classes.hpp"
#include "GCN_Athena_HidingProp_Tent_Rustle_parameters.hpp"


namespace SDK
{

// Function GCN_Athena_HidingProp_Tent_Rustle.GCN_Athena_HidingProp_Tent_Rustle_C.OnBurst
...
// Function GCN_Athena_HidingProp_Tent_Rustle.GCN_Athena_HidingProp_Tent_Rustle_C.OnBurstGeneric
// (Event, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class AActor*                           MyTarget                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FGameplayCueParameters&    Parameters                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
void UGCN_Athena_HidingProp_Tent_Rustle_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_HidingProp_Tent_Rustle_C", "OnBurstGeneric");

	Params::GCN_Athena_HidingProp_Tent_Rustle_C_OnBurstGeneric Parms{};
