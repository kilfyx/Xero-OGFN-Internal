...
{
public:
	uint8                                         Pad_28[0x3F0];                                     // 0x0028(0x03F0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_610[0x88];                                     // 0x0610(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000698, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, OnFinished) == 0x000458, "Member 'UMovieSceneSequencePlayer::OnFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x000468, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Sequence) == 0x000470, "Member 'UMovieSceneSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x000478, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, DurationFrames) == 0x00047C, "Member 'UMovieSceneSequencePlayer::DurationFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x000480, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x000484, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
